    ...
    <ChakraProvider theme={theme}>
      <Box w="full" minH="100vh" py={6} px={{ base: 2, md: 4 }}>
        ...
        >
          ...
          <Flex display={{ base: 'none', md: 'flex' }} wrap="wrap" justify="flex-end" gap={2}>
        ...
        <DrawerContent>
          ...
          <DrawerBody>
            <Stack spacing={4}>
              ...
              <FormControl>
                <FormLabel>Arabic Font Size: {arabicFontSize}px</FormLabel>
                <Slider
              ...
              <FormControl>
                <FormLabel>Translation Font Size: {translationFontSize}px</FormLabel>
                <Slider
